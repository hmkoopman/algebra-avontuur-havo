      ...
      {isVisible && (
        <div className="bg-card p-4 rounded-lg shadow-md">
          ...
          <ExplanationSection title="Kwadratische Vergelijkingen - Vorm x² = c">
            ...
            <p className="mb-2">De oplossing is: x = √c v x = -√c</p>
            <div className="mt-3 p-3 bg-secondary/50 rounded-md">
              <p className="mb-2"><b>Voorbeeld 1:</b> x² = 16</p>
              <p>x = √16 = 4 v x = -√16 = -4</p>
              <p className="mt-2">De oplossingen zijn dus x = 4 v x = -4</p>
            </div>
            <div className="mt-3 p-3 bg-secondary/50 rounded-md">
              <p className="mb-2"><b>Voorbeeld 2:</b> 3x² = 27</p>
              <p>x² = 9 <span className="text-muted-foreground">(deel beide kanten door 3)</span></p>
              <p>x = √9 = 3 v x = -√9 = -3</p>
              <p className="mt-2">De oplossingen zijn dus x = 3 v x = -3</p>
            </div>
          </ExplanationSection>

          <ExplanationSection title="Kwadratische Vergelijkingen (tweetermen) - Vorm ax² + bx = 0">
            <p className="mb-2">Bij een kwadratische tweeterm kunnen we x buiten haakjes halen. We halen de grootst mogelijke factor buiten haakjes.</p>
            ...
            <div className="mt-3 p-3 bg-secondary/50 rounded-md">
              ...
              <p>2x(x - 4) = 0</p>
              <p className="mt-2">Dus x = 0 v x - 4 = 0</p>
              <p>Dat geeft x = 0 v x = 4</p>
            </div>
          </ExplanationSection>

          <ExplanationSection title="Kwadratische Vergelijkingen (drietermen) - Vorm x² + bx + c = 0">
            <p className="mb-2">Een kwadratische vergelijking in de vorm x² + bx + c = 0 kunnen we oplossen met de productsommethode.</p>
            ...
            <ol className="list-decimal pl-5 space-y-2">
              <li>Zoek twee getallen die c als product hebben en b als som.</li>
            ...
            <div className="mt-3 p-3 bg-secondary/50 rounded-md">
              ...
              <p>We zoeken getallen p en q zodat p+q = 5 en p×q = 6</p>
              <p>Deze getallen zijn 2 en 3, want 2×3 = 6 en 2+3 = 5</p>
              <p>x² + 5x + 6 = x² + 2x + 3x + 6 = (x² + 2x) + (3x + 6) = x(x + 2) + 3(x + 2) = (x + 2)(x + 3)</p>
              <p className="mt-2">Dus x + 2 = 0 v x + 3 = 0</p>
              <p>De oplossingen zijn x = -2 v x = -3</p>
            </div>
          </ExplanationSection>
        </div>
      )}
